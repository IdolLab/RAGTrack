...
def main():
    ...
    parser.add_argument('--script', type=str, default='ragtrack', help='Name of the train script.')
    parser.add_argument('--config', type=str, default='RAGTrack', help="Name of the config file.")
